package org.isaagents.owl.reasoner;


import org.apache.log4j.Logger;
import org.isaagents.owl.OWLUtil;
...
public class ReasonerService {
   ...
   public void getDescendants(IRI classIRI){
    ...
    public static void main(String[] args) {
        ...
        //reasonerService.getDescendants(IRI.create("http://isa-agents.org/owl/ISA_10000258"));
        reasonerService.getDescendants(IRI.create("http://isa-agents.org/isa/ISA_0000105"));
