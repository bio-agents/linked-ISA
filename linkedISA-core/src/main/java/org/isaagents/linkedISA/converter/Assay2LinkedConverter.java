...
import org.isaagents.graph.model.*;
import org.isaagents.graph.model.impl.*;

import org.isaagents.graph.parser.GraphParser;
import org.isaagents.isacreator.ontologymanager.OntologyManager;
import org.isaagents.owl.BFO;
import org.isaagents.owl.ISA;
import org.isaagents.owl.OBI;
...
public class Assay2LinkedConverter {
    ...
    */
     ...
     *
     * @param graph the ISA-TAB files parsed as a org.isaagents.graph
    ...
    private String getProcessParametersPerformerDateString(int processRow, ProtocolExecutionNode processNode){
        ...
        //date
        org.isaagents.graph.model.impl.Date date = processNode.getDate();
        if (date!=null){
